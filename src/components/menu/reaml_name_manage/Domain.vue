<template>
	<div class = "_content">
		...
		<div id="add_btn">
			<a>域名设置</a>
			<el-button type="text" @click="dialogFormVisible = true">新增域名</el-button>
